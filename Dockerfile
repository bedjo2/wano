...
COPY src /usr/src/wano/
WORKDIR /usr/src/wano
...
RUN chmod +x /usr/src/wano/tasks.py \
    && chmod +x /usr/src/wano/entrypoint.sh
...
# ENTRYPOINT /usr/src/wano/entrypoint.sh
